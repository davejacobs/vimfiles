...
"
" syn region soarCond  matchgroup=soarCondParen start=/-\?(/ end=/)/ nextgroup=soarCond,soarDisjunc,soarArrow contains=soarCondI,NoInParens contained skipwhite skipnl
