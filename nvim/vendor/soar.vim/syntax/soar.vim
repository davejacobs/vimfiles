...
syn region soarCond  matchgroup=soarCondParen start=/-\?(/ end=/)/ nextgroup=soarCond,soarDisjunc,soarArrow contains=soarCondI,soarConjTest,soarDisjTest contained skipwhite skipnl
syn region soarCondI start=/(/ms=e+1 end=/)/me=s-1 contained

syn region soarConjTest start=/{/ end=/}/ containedin=soarCond contained extend contains=soarVar,soarAttrib,soarString,soarDisjTest
syn region soarDisjTest start=/<</ end=/>>/ containedin=soarCond,soarConjTest contained contains=soarVar,soarString

syn region soarDisjunc start=/-{/ end=/}/ nextgroup=soarCond,soarDisjunc,soarArrow contains=soarCond contained skipwhite skipnl extend

syn match  soarArrow /-->/ nextgroup=soarAction skipwhite skipnl contained

syn region soarAction  matchgroup=soarActionParen start=/(/ end=/)/ nextgroup=soarAction contains=soarActionI,soarVar,soarAttrib,soarString contained skipwhite skipnl
syn region soarActionI start=/(/ms=e+1 end=/)/me=s-1 contained

syn match  soarVar     /<[-_a-zA-Z0-9]\+>/      containedin=soarCond,soarAction,soarConjTest,soarDisjTest contained
syn match  soarAttrib  /-\?\^[-\._a-zA-Z0-9]\+/ containedin=soarCond,soarAction,soarConjTest contained
syn region soarString start=/|/ end=/|/ containedin=soarCond,soarAction,soarConjTest,soarDisjTest contained
...
hi link soarVar       Type
hi link soarAttrib    Character
hi link soarComment   Comment
hi link soarString    String
hi link soarConjTest  Special
hi link soarDisjTest  Special
